...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _navigationlisteners__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./navigationlisteners */ \"./src/navigationlisteners.js\");\n\n\n\n\n\n(0,_navigationlisteners__WEBPACK_IMPORTED_MODULE_0__.windowRefresh)()\n\n;(0,_navigationlisteners__WEBPACK_IMPORTED_MODULE_0__.addProjModal)()\n;(0,_navigationlisteners__WEBPACK_IMPORTED_MODULE_0__.remProjModal)()\n;(0,_navigationlisteners__WEBPACK_IMPORTED_MODULE_0__.showProjList)()\n;(0,_navigationlisteners__WEBPACK_IMPORTED_MODULE_0__.addProject)()\n\n\n\n//# sourceURL=webpack://to-do/./src/index.js?");

/***/ }),

/***/ "./src/navigationDOM.js":
/*!******************************!*\
  !*** ./src/navigationDOM.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"appendProject\": () => (/* binding */ appendProject)\n/* harmony export */ });\n/* harmony import */ var _navigationlogic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./navigationlogic */ \"./src/navigationlogic.js\");\n\n\nconst projInput = document.querySelector('#projectinput')\nconst projList = document.querySelector('.projlist')\n\nconst appendProject = (projName) => {\n    if (projInput.value === '') {return}\n    (0,_navigationlogic__WEBPACK_IMPORTED_MODULE_0__.saveLocalStorageProj)(projName)\n    const listItem = document.createElement('li')\n    listItem.innerText = projInput.value\n    listItem.classList.add(projInput.value)\n    projList.appendChild(listItem)\n    console.log(localStorage)\n}\n\n\n\n\n\n//# sourceURL=webpack://to-do/./src/navigationDOM.js?");

/***/ }),

/***/ "./src/navigationlisteners.js":
/*!************************************!*\
  !*** ./src/navigationlisteners.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addProjModal\": () => (/* binding */ addProjModal),\n/* harmony export */   \"addProject\": () => (/* binding */ addProject),\n/* harmony export */   \"appendProject\": () => (/* reexport safe */ _navigationDOM__WEBPACK_IMPORTED_MODULE_1__.appendProject),\n/* harmony export */   \"remProjModal\": () => (/* binding */ remProjModal),\n/* harmony export */   \"showProjList\": () => (/* binding */ showProjList),\n/* harmony export */   \"windowRefresh\": () => (/* binding */ windowRefresh)\n/* harmony export */ });\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _navigationDOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./navigationDOM */ \"./src/navigationDOM.js\");\n/* harmony import */ var _navigationlogic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./navigationlogic */ \"./src/navigationlogic.js\");\n\n\n\n\nconst addProjectBtn = document.querySelector('.addproj')\nconst projModal = document.querySelector('.modalcont')\nconst escProjModal = document.querySelector('.esc')\n\nconst projSubmitBtn = document.querySelector('#projsubmit')\n\nconst projects = document.querySelector('.projtitle')\nconst projList = document.querySelector('.projlist')\nconst listItem = document.querySelector('li')\n\nconst projInput = document.querySelector('#projectinput')\n\nconst appendToDO = () => {\n    \n}\n\n// Draws HTML list items back to page on refresh\nconst windowRefresh = () => {\n    window.addEventListener('load', (e) => {\n        ;(0,_navigationlogic__WEBPACK_IMPORTED_MODULE_2__.drawListItem)()\n        \n    })\n}\n\n// Form pop up that allows you to add project list items\nconst addProjModal = () => {\n    addProjectBtn.addEventListener('click', (e) => {\n        projInput.value = ''\n        projModal.classList.add('modalactive')\n    })\n}\n\n// Allows you to exit form by clicking \"X\"\nconst remProjModal = () => {\n    escProjModal.addEventListener('click', (e) => {\n        projModal.classList.remove('modalactive')\n    })\n}\n\n// Allows you to view list items\nconst showProjList = () => {\n    projects.addEventListener('click', (e) => {\n        projList.classList.toggle('projlist-active')\n    })\n}\n\n// Appends list items to page\nconst addProject = () => {\n    projSubmitBtn.addEventListener('click', (e) => {\n        ;(0,_navigationDOM__WEBPACK_IMPORTED_MODULE_1__.appendProject)(projInput.value)\n        projModal.classList.remove('modalactive')\n        if (projList.classList.contains('projlist-active')) {return}\n        if (projList.classList.contains('projlist-active') === false) {projList.classList.add('projlist-active')}\n        \n    })\n}\n\n\n\n\n//# sourceURL=webpack://to-do/./src/navigationlisteners.js?");
